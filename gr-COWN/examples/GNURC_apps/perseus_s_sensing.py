...
# Generated: Wed Aug 26 18:24:46 2015
##################################################
...
class perseus_s_sensing(gr.top_block, Qt.QWidget):
    ...
    def get_funcion_prove_showts_edge(self):
        return self.funcion_prove_showts_edge

    def set_funcion_prove_showts_edge(self, funcion_prove_showts_edge):
        self.funcion_prove_showts_edge = funcion_prove_showts_edge
    ...
    def get_cosenito(self):
        return self.cosenito

    def set_cosenito(self, cosenito):
        self.cosenito = cosenito
    ...
    def set_RF_freq(self, RF_freq):
        ...
        self.nutaq_radio420_rx_0_0.set_rx_gain(10)
