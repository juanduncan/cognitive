...
# Title: Test Float Conversion
# Generated: Wed Oct 28 18:57:04 2015
##################################################
...
class test_float_conversion(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_0_0_0_0.set_y_axis(-0.1, 1000)
        
        self.qtgui_time_sink_x_0_0_0_0_0.set_y_label("Amplitude COMPLEX", "")
        
        self.qtgui_time_sink_x_0_0_0_0_0.enable_tags(-1, True)
        self.qtgui_time_sink_x_0_0_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, threshold, 5e-3, 0, "FISTOR")
        ...
        self.connect((self.carajito, 0), (self.qtgui_time_sink_x_0_0_0_0_0, 0))    
