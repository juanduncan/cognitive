...
# Title: Top Block
# Generated: Wed Nov 11 11:47:26 2015
##################################################
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._period_range = Range(1, 10000, 1, 3000, 200)
        ...
        self.nutaq_rtdex_sink_0.set_packet_size(packet_size*2)
        ...
        self.misc2_cf_to_s16_v2_0 = misc2.cf_to_s16_v2(2047)
        (self.misc2_cf_to_s16_v2_0).set_min_output_buffer(10000)
        ...
        self._freq1_range = Range(-250000, 250000, 1, 10000, 200)
        ...
        self.foo_packet_pad2_0_0 = foo.packet_pad2(True, False, 0.00000001, 499+1000, 500+1000)
        (self.foo_packet_pad2_0_0).set_min_output_buffer(96000)
        ...
        self.connect((self.foo_packet_pad2_0_0, 0), (self.misc2_cf_to_s16_v2_0, 0))    
        self.connect((self.misc2_cf_to_s16_v2_0, 0), (self.nutaq_rtdex_sink_0, 0))    
        self.connect((self.wifi_PHY_tx_hier_1, 0), (self.foo_packet_pad2_0_0, 0))    
